...
const ContactWithUSection = () => {
    return (
        <section className="relative z-10 py-8 md:py-10 lg:py-16 xl:py-20 px-6 md:px-8 lg:px-11 xl:px-16 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-[url('/programmes/footer-bg.svg')] bg-cover bg-center bg-no-repeat opacity-10 pointer-events-none" />
                    ...
                    <div className="lg:col-span-3">
                        ...
                        >
                            ...
                            <div className="flex flex-col">
                                <span className="text-white/60 text-xs md:text-sm font-medium uppercase tracking-wider mb-0.5 font-poppins">
                                    Call Us
                                </span>
