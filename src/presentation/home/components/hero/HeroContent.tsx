...
export const HeroContent = ({
  ...
  return (
    <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-16 lg:px-24 z-20 text-white">
      <div className="max-w-4xl w-full">
        <p
          className="text-[16px] text-center sm:text-left sm:text-[20px] md:text-[24px] lg:text-[35px] font-normal tracking-tight mb-3 sm:mb-4 leading-[1.3] opacity-95"
          style={{ textShadow: "0 2px 4px rgba(0,0,0,0.5)" }}
        >
          {subtitle}
        </p>
        <h1
          className="text-[32px] text-center sm:text-left sm:text-[44px] md:text-[56px] lg:text-[70px] font-semibold tracking-tighter mb-4 sm:mb-6 leading-[1.05]"
