    ...
    return (
        <section className="relative w-full overflow-hidden pt-10 pb-10 md:py-12 xl:pt-12 xl:pb-20 font-poppins">
            <div className="w-full max-w-[1530px] mx-auto relative z-10">
                <div className="flex items-center justify-between gap-0 md:gap-4 mb-6">
                    <SectionTitle
                        title={title}
                        className="mb-0 text-3xl md:text-4xl xl:text-[42px]"
                    />
                    {(newsandeventbtn?.buttonlink ||
                        ...
                        >
                            ...
                            <span className="font-normal tracking-wide  hidden md:block  md:text-[16px]">
                ...
                >
                    {newsandeventsdata?.data?.map(
                        (event: NewsEventDomain, i: number) => (
