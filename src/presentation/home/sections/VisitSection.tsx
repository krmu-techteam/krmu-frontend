  ...
  return (
    <section className="relative w-full py-10 md:py-12 xl:py-20 overflow-hidden font-poppins">
      <div className="relative w-full flex flex-col lg:flex-row items-stretch gap-6 xl:gap-16">
        ...
        <div className="w-full lg:w-[45%] flex flex-col justify-center px-6 md:px-12 xl:pl-16 2xl:pl-64 py-10 md:py-16 lg:py-20 relative z-10">
          <div className="w-full max-w-[620px] lg:ml-0 flex flex-col">
            ...
            <div className="flex flex-row items-center justify-start gap-4 md:gap-8">
              {/* Schedule Visit */}
              <button className="flex items-center gap-4 xl:gap-6 p-3 xl:p-5 rounded-[4px] border border-white group max-w-[240px] xl:max-w-[280px] text-left h-[70px] xl:h-[80px] text-white">
                <div>
                  <CalendarCheck className="text-[22px] xl:text-[26px]" />
                </div>
                <div>
                  <h4 className="text-white/80 font-medium text-[14px] xl:text-[17px] leading-relaxed xl:leading-tight">
