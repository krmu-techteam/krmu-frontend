...
const CareerProspectsSection = ({
    ...
    return (
        <section
            id="career-prospects"
            className="relative py-6 lg:pt-12 2xl:pt-16 2xl:pb-[80px] xl:pb-[150px] overflow-hidden min-h-[600px] md:min-h-[750px] xl:min-h-[850px] flex flex-col items-center scroll-mt-28"
        >
