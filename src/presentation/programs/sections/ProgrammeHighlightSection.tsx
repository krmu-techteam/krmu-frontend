...
const ProgrammeHighlight = ({
    ...
    return (
        <section
            id="highlights"
            className="relative z-10 py-10 lg:py-16 xl:py-20 scroll-mt-28"
        >
                    ...
                    >
                        <div className="flex xl:ml-0 2xl:-ml-4 ">
                            {highlights?.map((highlight) => (
                                <div
                                    key={highlight.id}
                                    className="flex-[0_0_100%] sm:flex-[0_0_50%] lg:flex-[0_0_33%] xl:flex-[0_0_25%] lg:pl-2 xl:pl-2 2xl:pl-4 min-w-0"
                                >
