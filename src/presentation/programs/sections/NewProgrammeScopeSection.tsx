...
const ProgrammeScopeSection = async ({
  ...
  return (
    <section
      className={`bg-[linear-gradient(0deg,rgba(0,0,0,0.2),rgba(0,0,0,0.2)),linear-gradient(180deg,#061623_0%,#001732_100%)] text-white py-8 md:py-12 xl:py-20 font-poppins`}
    >
