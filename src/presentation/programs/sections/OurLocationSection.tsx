...
const OurLocationSection = ({
    ...
    img2,
    slug,
}: OurLocationSectionProps & { slug?: string }) => {
    return (
                ...
                <div className="sm:w-5/12">
                    <Image
                        ...
                        alt={resolveSoetProgramAlt(
                            slug,
                            img1?.url,
                            img1?.alternativeText || "Our Location"
                        )}
                    />
                </div>
                <div className="sm:w-7/12 pt-6 px-0 lg:px-0 xl:px-3">
                    <p className="py-2.5 font-normal rounded-md font-poppins text-slate-100 text-sm tracking-wider inline-block m-0">
                        {badgetext}
                    </p>
                    <h2 className="text-slate-100 text-[20px] font-poppins lg:text-[25px] font-medium mb-4">
                    ...
                    <Image
                        ...
                        alt={resolveSoetProgramAlt(
                            slug,
                            img2?.url,
                            img2?.alternativeText || "our location Map"
                        )}
                        width={608}
                        height={258}
