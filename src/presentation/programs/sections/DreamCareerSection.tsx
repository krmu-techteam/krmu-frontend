...
import { DreamCareerSectionProps } from "@/features/programs";
import { resolveProgramRecruiterAlt } from "@/alt-text/programs/soet";

const DreamCareerSection = ({ heading, logos }: DreamCareerSectionProps) => {
    return (
        <section className="py-8 md:py-16 bg-white overflow-hidden px-4 lg:px-16 2xl:px-0">
