...
const ProgrammeOverviewSection = () => {
  ...
  return (
    <section className={`w-full bg-transparent py-8 md:py-12 xl:py-20`}>
      <div className="max-w-[1530px] mx-auto px-8 md:px-8 xl:px-16">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-start w-full">
            <h2 className="heading-primary mb-4">Programme Overview</h2>

            <div
              className={`overflow-hidden font-poppins transition-all duration-700 ease-in-out ${
                isExpanded ? "max-h-[1000px]" : "max-h-[52px]"
              }`}
            >
              <div
                className={`text-white text-[16px] leading-[130%] font-light w-full transition-opacity duration-500 ${
            ...
            <a
              ...
              className="inline-block font-normal text-white text-[16px] underline underline-offset-4 decoration-1 hover:text-white/80 hover:decoration-2 transition-all duration-300 cursor-pointer mt-4"
            >
