...
const EligibilitySection = ({
    ...
    return (
        <>
            <section
                id="eligibility"
                className={`pb-10 pt-0 lg:pb-16 xl:pb-20 relative z-10 border-gray-100 scroll-mt-28`}
            >
                <div
                    className={`max-w-[1530px] w-full mx-auto px-4 md:px-8 xl:px-16`}
                >
                    ...
                    {[
                        ...
                        <p className="my-5 italic">
                            *In addition to the regular programme fee at KRMU,
                            students will be required to pay an additional
