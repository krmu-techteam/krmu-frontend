...
const CinematicRecruiterStrip = ({
    ...
    return (
        <div className="w-full pt-10 py-8 pb-10 lg:pt-16 xl:pt-20">
            <div className="max-w-[1440px] mx-auto px-0 md:px-0 lg:px-10 2xl:px-0 relative">
                {/* Centered Heading Badge */}
                <div className="absolute -top-[77px] sm:-top-1 md:-top-[80px] lg:-top-[105px] xl:-top-[119px] left-1/2 -translate-x-1/2 bg-[#152635]/85 px-6 py-2 rounded-t-[4px] flex items-center justify-center z-20">
                    <h3 className="text-white font-poppins text-[14px] sm:text-[17px] font-normal whitespace-nowrap">
