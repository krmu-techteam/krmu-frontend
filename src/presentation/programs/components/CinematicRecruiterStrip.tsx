...
const CinematicRecruiterStrip = ({
    ...
    return (
        <div className="w-full py-3 sm:py-5 lg:py-12">
            <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-10 2xl:px-0 flex flex-col items-center">
                {/* Centered Heading Badge */}
                <div className="bg-[#061623] px-5 sm:px-6 py-1.5 rounded-[3px] flex items-center justify-center mb-3 sm:mb-5 lg:mb-6">
                    <p className="text-white/90 font-poppins text-[13px] sm:text-[15px] font-medium whitespace-nowrap">
