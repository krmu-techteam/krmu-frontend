        ...
        <div className="w-full antialiased">
            <div className="container mx-auto relative">
                ...
                <div className="relative w-full">
                      ...
                      ${
                          isYearActive
                              ...
                              : "text-[#061623] bg-[#EAEAEA] hover:bg-[#DEDEDE]"
                                        ...
                                        >
                                            <h3 className="m-0 text-inherit font-inherit text-sm lg:text-[16px] 2xl:text-lg font-semibold inline-block">
                                                {year.year}
                                            </h3>
                                        </button>
                                    );
                    ...
                    `}
                                            >
                                                <h4 className="m-0 text-inherit font-inherit text-[17px] md:text-xl font-normal inline-block">
                                                    {sem.semestername}
                                                </h4>
                                                <div
