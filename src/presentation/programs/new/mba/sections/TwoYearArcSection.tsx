...
export const TwoYearArcSection = () => {
    ...
    <section className="w-full bg-[#FDF7EB] text-[#012D52]">
      <div className="max-w-[1440px] mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-10 lg:py-14">
        ...
        <div className="mb-6 sm:mb-8">
          <span className="font-inter text-[#A17200] text-[10px] sm:text-[12px] lg:text-[15px] font-semibold tracking-[0.7px] uppercase block mb-2">
            {content.badge}
          </span>
          <h2 className="font-fraunces text-[#0F2A4D] text-xl sm:text-2xl md:text-3xl lg:text-[38px] leading-tight font-medium max-w-4xl">
            {content.title}
          </h2>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Period Name */}
                  <div className="font-inter text-[10px] sm:text-[11px] lg:text-[12px] font-bold tracking-[0.1em] uppercase mb-1.5 sm:mb-2 text-[#A17200] transition-colors duration-500">
                    {sem.period}
                  </div>

                  {/* Title */}
                  <h3 className="font-fraunces text-base sm:text-[15px] lg:text-[16px] tracking-wide font-bold mb-2 sm:mb-3 lg:mb-4 text-[#0F2A4D] group-hover:text-white transition-colors duration-500">
                    {sem.title}
                  </h3>

                  {/* Description */}
                  <p
                    className={`font-inter text-[12px] lg:text-[13px] text-[#012D52] group-hover:text-[#F7F0E0] opacity-[77%] font-medium transition-colors duration-500 leading-relaxed ${!isOpen ? "line-clamp-2 lg:line-clamp-3" : ""}`}
                  >
...
export default TwoYearArcSection;
