...
export interface ExperimentalInfraSectionProps {
  dataContent?: ExperimentalInfraPageContentType | null;
}

export const ExperimentalInfraSection = ({
  dataContent,
}: ExperimentalInfraSectionProps) => {
...
export default ExperimentalInfraSection;
