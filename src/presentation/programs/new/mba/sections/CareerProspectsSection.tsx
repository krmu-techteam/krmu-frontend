...
export const CareerProspectsSection = ({ slug }: CareerProspectsSectionProps) => {
      ...
      <div className="max-w-[1440px] mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-10 lg:py-14">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            {/* Subheading / Badge */}
            <span className="font-inter text-[#BFA477] text-xs sm:text-[11px] leading-[16px] font-medium tracking-[1.54px] uppercase block mb-3">
              {content.badge}
            </span>

            {/* Title */}
            <h2 className="font-fraunces text-white text-3xl sm:text-4xl md:text-5xl lg:text-[38px] font-semibold mb-6">
              {content.title}
            </h2>

            {/* Description */}
            <p className="font-inter text-white text-sm sm:text-base md:text-[14px] tracking-[0.2px] mb-12 sm:mb-16 max-w-[598px]">
              {content.description}
            </p>
                        ...
                        return (
                          <React.Fragment key={itemIdx}>
                            ...
                            <div className="flex-1 flex flex-col">
                              <h3 className="font-fraunces text-white text-xl sm:text-2xl md:text-[21px] mb-3">
                                {item.title}
                              </h3>
                              <p className="font-inter text-white text-[13px] sm:text-[14px]">
                                {item.desc}
                              </p>
                            </div>

                            {/* White Vertical Line Separator (Only between items, on desktop/tablet size) */}
                            {!isLastItem && (
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="hidden md:block relative w-full max-w-[480px] aspect-[4/3] sm:aspect-[1/1] lg:aspect-[1/1] overflow-hidden rounded-[4px] shadow-2xl">
              <Image
                src={
                  slug === "mba-fintech"
                    ? content.image
                    : slug === "mba-digital-marketing"
                      ...
                      : slug === "mba"
                        ...
                        : content.image || "https://truthful-cabbage-82fd27e8f6.media.strapiapp.com/Rectangle_1602_1bf41df812.jpg"
                }
                alt={
                  slug === "mba-fintech"
