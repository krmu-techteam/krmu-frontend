...
export const FacultyAndIndustrySection = ({
    slug,
    dataContent,
}: FacultyAndIndustrySectionProps) => {
        ...
        <section className="w-full bg-[#F7F0E0] text-[#012D52]">
            ...
            <div className="w-full">
                <div className="max-w-[1440px] mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-10 lg:py-14">
                    ...
                    <div className="w-full flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-14 items-start">
                        {/* Left Column: Image Banner */}
                        <div className="w-full lg:w-[496px] max-w-[496px] shrink-0">
                            <div className="relative w-full aspect-[496/486] overflow-hidden shadow-xl shadow-slate-900/10">
                                <Image
                        ...
                        >
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <div className="flex items-center gap-4 mx-4">
                                    <CarouselPrevious
                                        variant="ghost"
                                        className="static translate-y-0 w-10 h-10 md:w-10 md:h-10 rounded-full bg-[#F7F0E0] text-[#012D52] hover:bg-[#012D52] hover:text-white border border-[#BCB093]/40 transition-all duration-300 flex items-center justify-center cursor-pointer"
                                    />
                                    <CarouselNext
                                        variant="ghost"
                                        className="static translate-y-0 w-10 h-10 md:w-10 md:h-10 rounded-full bg-[#F7F0E0] text-[#012D52] hover:bg-[#012D52] hover:text-white border border-[#BCB093]/40 transition-all duration-300 flex items-center justify-center cursor-pointer"
...
export default FacultyAndIndustrySection;
