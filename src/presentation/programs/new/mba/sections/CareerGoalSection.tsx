    ...
    return (
        <section className="w-full bg-[#F7F0E0] text-[#012D52]">
            <div className="max-w-[1440px] mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-10 lg:py-14">
                ...
                <p
                    className={`${inter.className} py-3 italic text-xs text-black/60`}
                >
                    *Tentative. The final course structure will be shared at the
                    time of orientation.
                </p>
                {/* Semester Tab Row */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div
                        ...
                        className="lg:col-span-8 flex flex-col gap-3 animate-[fadeIn_0.5s_ease-out] w-full"
                    >
