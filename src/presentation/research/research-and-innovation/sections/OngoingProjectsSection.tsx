...
const OnGoingProjectsSection = ({
  ...
  const { title, description_one, description_two, description_three, images } =
    onGoingProjectsSection;
  ...
  return (
    <section
      ...
      id="_ongoing-collab"
    >
      <div className="max-w-[1530px] mx-auto w-full flex flex-col lg:flex-row gap-10 items-center px-6 md:px-8 xl:px-16">
