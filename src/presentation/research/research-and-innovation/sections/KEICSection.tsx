...
const KEICSection = ({ keicSection }: { keicSection: KEICSectionProps }) => {
  ...
  return (
    <section className="relative bg-black bg-cover bg-center pt-[50px] pb-[30px] px-8 md:px-12 xl:py-20">
      <div className="max-w-[1530px] mx-auto w-full flex flex-col lg:flex-row gap-16 items-center px-6 md:px-8 xl:px-16">
        ...
        <div className="text-white lg:w-3/5">
          ...
          <Link
            href={linkInfo?.url}
            className="font-poppins blink-effect common-btn-3 mt-5"
          >
            {linkInfo?.label}
          </Link>
        </div>
