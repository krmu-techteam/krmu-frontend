...
import { HeroSectionProps } from "@/features/life-at-krmu/youth-red-cross-committee/types";
...
const HeroSection = ({ heroSection }: { heroSection: HeroSectionProps }) => {
  ...
  return (
    <section className="bg-[url(/bg-gradient.webp)] font-poppins bg-no-repeat bg-cover pt-[140px] lg:pt-[10%] pb-[3%]">
      <div className="max-w-[1530px] mx-auto w-full flex flex-col lg:flex-row items-center text-white px-6 md:px-7 xl:px-16">
