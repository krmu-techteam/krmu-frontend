          ...
          <div className="w-full max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-16 xl:px-20">
            <div className="max-w-[1060px]">
              ...
              <h2 className="text-[#000000] font-poppins text-2xl sm:text-3xl lg:text-[34px] tracking-normal mb-4 sm:mb-6 leading-tight">
                ...
                <span className="font-bold">K.R Mangalam University</span>
              </h2>
              ...
              <p className="text-[#000000] font-poppins text-[15px] sm:text-[17px] lg:text-[18px] xl:text-[18.5px] font-normal leading-[1.75] sm:leading-[1.8] lg:leading-[1.85]">
                K.R Mangalam University has allowed credit transfer from SWAYAM,
                enabling students to integrate online courses into their
                academic programs. A maximum of 40% of the total courses in a
                particular program per semester can be taken through the SWAYAM
                platform, providing students with extra learning opportunities
                without contributing to credit requirements. This initiative
                aligns with K.R Mangalam University’s commitment to flexible and
                technology-driven education, allowing students to enhance their
                knowledge through high-quality online resources
              </p>
            </div>
          </div>
        </div>
