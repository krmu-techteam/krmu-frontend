          ...
          {navTabs.map((tab, idx) =>
            tab.modalType ? (
              <button
                ...
                className="px-4 sm:px-5 py-2 sm:py-2.5 bg-white border border-[#D1D5DB] rounded-[2px] text-[#1F2937] hover:text-[#CB000D] hover:border-[#CB000D] font-medium text-sm sm:text-[15px]   transition-all duration-200 whitespace-nowrap cursor-pointer"
              >
                {tab.label}
              </button>
            ) : (
              <a
                ...
                className="px-4 sm:px-5 py-2 sm:py-2.5 bg-white border border-[#D1D5DB] rounded-[2px] text-[#1F2937] hover:text-[#CB000D] hover:border-[#CB000D] font-medium text-sm sm:text-[15px]   transition-all duration-200 whitespace-nowrap"
              >
                {tab.label}
              </a>
            ),
                ...
                >
                  ...
                  <div
                    className={`w-full h-full relative ${
                      activeTutorialId === "abc-id" ? "block" : "hidden"
                    }`}
                  >
                    <iframe
                      ref={iframeRef}
