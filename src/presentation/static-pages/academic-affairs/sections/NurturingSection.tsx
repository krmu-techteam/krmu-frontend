...
const NurturingSuccessSection = () => {
    return (
        <section className="relative pb-12 md:pb-12 bg-transparent">
            <div className="max-w-[1530px] mx-auto w-full relative mt-12 md:mt-20 px-4 md:px-8 xl:px-16">
                ...
                >
                    ...
                    <div className="w-full md:w-[55%] mb-10 lg:w-2/3 p-6 pb-[280px] md:p-8 xl:p-16 text-white z-10 font-poppins relative">
                        <h2 className="heading-primary !text-[26px] md:!text-[30px] lg:!text-[40px] mb-4 md:mb-6 !text-left">
                            Nurturing Success Beyond the Classroom
                        </h2>
                        <p className="text-[15px] md:text-[16px] text-gray-300 mb-8 leading-[1.7] max-w-2xl">
                            We provide a plethora of resources and support
                            systems to aid our students’ academic and personal
                            growth, including:
                        </p>
                        <ul className="flex flex-col gap-5">
                            <li className="flex items-start gap-4">
                                ...
                                <span className="text-gray-300 text-[15px] md:text-[16px]">
                                    Academic planning and career counselling
                                    services.
                                </span>
                            </li>
                            <li className="flex items-start gap-4">
                                ...
                                />
                                <span className="text-gray-300 text-[15px] md:text-[16px]">
                                    Tutoring, mentoring, and psychological
