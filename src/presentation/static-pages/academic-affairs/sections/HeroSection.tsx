...
const HeroSection = () => {
  ...
  return (
    <section className="bg-[#07141E] w-full pt-[170px] pb-12 text-white">
      <div className="max-w-[1530px] mx-auto px-6 md:px-8 xl:px-16 w-full flex gap-10 flex-col lg:flex-row items-center lg:items-start justify-between">
        {/* LEFT CONTENT */}
        <div className="w-full lg:w-[calc(100%-400px)] flex flex-col">
          ...
          <div className="flex flex-col gap-2 text-[16px] text-gray-300 font-poppins">
            <p>
              ...
              that thrives on intellectual curiosity, collaborative learning,
            ...
            <p>
              ...
              and innovative thinking. I request you all to make the most of
              your academic journey by seeking out opportunities for research,
            ...
            >
              <div className="overflow-hidden flex flex-col gap-2">
                ...
                <p>
                  ...
                  academic endeavours. If you have any questions, concerns, or
                  if there’s anything we can assist you with, please feel free
                  to reach out. We are committed to providing a nurturing
                  academic environment that fosters growth, learning, and
                  success.
                </p>
              </div>
            </div>
