  ...
  return (
    <section className="relative py-8 md:py-12 xl:py-20">
      <div className="max-w-[1530px] mx-auto w-full text-white px-6 md:px-8 xl:px-16">
        ...
        <p className="text-center text-base md:text-lg text-gray-300 font-poppins mb-12">
        ...
        <div className="w-full flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6">
            {/* Main Card */}
            <div className="p-6 md:p-8 flex flex-col md:flex-row gap-6 bg-[#030303]/30 rounded-[10px] h-full">
              {/* Image & Name */}
              <div className="w-full md:w-[220px] flex flex-col items-center shrink-0">
                <Image
                  ...
                  className="rounded-[8px] object-cover w-full max-w-[220px]"
                />
              ...
              {/* Description */}
              <div className="text-[14px] text-gray-300 text-justify md:text-left leading-[1.7] font-poppins">
                <p>
                  Dean of Academics: Prof. Varuna Tyagi, MBA and PhD in
                  ...
                  strategies with a focus on inclusivity and global relevance.
                  She is highly skilled and accomplished training professional
                  with extensive knowledge of design, development, delivery, and
                  evaluation of wide range of training activities. She plays a
            ...
            {/* Small Card */}
            <div className="p-6 md:p-8 bg-[#030303]/30 rounded-[8px] text-[14px] text-gray-300 font-poppins">
              <p>
                <strong className="text-white">Faculty Coordinators:</strong>{" "}
                Our dedicated coordinators, experts in their respective fields,
                ensure the effective delivery of our diverse academic programs.
              </p>
            </div>
          </div>
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6">
            {/* Main Card */}
            <div className="p-6 md:p-8 flex flex-col md:flex-row gap-6 bg-[#030303]/30 rounded-[8px] h-full">
              {/* Image & Name */}
              <div className="w-full md:w-[220px] flex flex-col items-center shrink-0">
                <Image
                  ...
                  className="rounded-[10px] object-cover w-full max-w-[220px]"
                />
                <div className="text-white mt-4 text-center font-poppins">
                  <p className="text-[17px] font-semibold">
            ...
            <div className="p-6 md:p-8 bg-[#030303]/30 rounded-[8px] text-[14px] text-gray-300 font-poppins">
              <p>
                <strong className="text-white">Administrative Staff:</strong>{" "}
                The backbone of our office, providing indispensable support in
                the implementation of academic policies and student services.
              </p>
            </div>
          </div>
        </div>
