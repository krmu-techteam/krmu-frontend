    ...
    return (
        <section className="relative py-8 md:py-12 xl:py-20 bg-transparent">
            <div className="max-w-[1530px] mx-auto w-full px-4 md:px-8 xl:px-16 flex flex-col items-center">
                <h2 className="text-[22px] font-bold font-serif text-white md:text-[36px] xl:text-[42px] text-center mb-4">
                    Aligning with National Education Policy (NEP – 2020)
                </h2>
                <p className="text-center text-[15px] md:text-[16px] text-white/90 font-poppins max-w-4xl mb-8">
                    At KRMU, we recognize the importance of aligning our
                    academic approach with the National Education Policy (NEP)
                    to provide an education that is both contemporary{" "}
                    <br className="hidden" /> and comprehensive.
                </p>
                <Button
                ...
                <div className="w-full">
                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full text-left font-poppins">
                        {NEP_FEATURES.map((feature, index) => (
                            <li
                                key={index}
                                className={`flex gap-2 md:gap-4 p-4 md:p-7 rounded-[8px] border border-[#797979] ${
                            ...
                            >
                                ...
                                <div className="flex flex-col">
                                    <span className="text-white font-semibold text-[15px] md:text-[17px]">
                                        {feature.title}
                                    </span>
                                    <span className="text-white/90 text-[13px] md:text-[14px] leading-[1.7]">
                                        {feature.description}
                                    </span>
                                </div>
                            </li>
