...
export * as Sdg4QualityEducation from "./sdg-4-quality-education";
export * as Sdg5GenderEquality from "./sdg-5-gender-equality";
export * as Sdg6CleanWaterAndSanitation from "./sdg-6-clean-water-and-sanitation";
export * as Sdg7AffordableAndCleanEnergy from "./sdg-7-affordable-and-clean-energy";
export * as Sdg8DecentWorkAndEconomicGrowth from "./sdg-8-decent-work-and-economic-growth";
