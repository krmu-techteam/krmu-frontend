      ...
      <div className="relative w-full pt-[110px]">
        ...
        <div className="relative w-full h-[506px] overflow-hidden flex flex-col items-center justify-center text-center px-6">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center">
            ...
            {/* Centered Heading */}
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-[55px] font-bold text-white tracking-wide leading-tight sm:leading-snug max-w-4xl">
              Centre of Excellence for <br className="hidden sm:inline" />
