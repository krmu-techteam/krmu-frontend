                ...
                return (
                    ...
                    >
                        ...
                        <button
                            ...
                            className={`w-full h-[56px] lg:h-[72px] px-3 lg:px-6 flex items-center justify-between text-left font-normal text-[15px] sm:text-[22px] text-white cursor-pointer rounded-[4px] border transition-all duration-300 ${
                                isOpen
                        ...
                        >
                            ...
                            <div className="p-1.5 rounded-full bg-white/10 text-white shrink-0 ml-4">
                                <ChevronDown
                                    className={`w-3.5 h-3.5 lg:w-5 lg:h-5 text-white transition-transform duration-300 ${
                                    ...
                                    <div className="py-6 sm:py-8 bg-transparent">
                                        {trigger.id === "sustain-panel-1" ? (
                                          ...
                                          "sustain-panel-14" ? (
                                            ...
                                            <div className="pt-2 pb-2 text-left space-y-6">
                                                ...
                                                <div className="space-y-4 text-gray-300 text-sm sm:text-base font-light leading-relaxed text-justify">
                                                    ...
                                                    <p>
                                                        To further its green
                                                        initiatives, the
                                                        university actively
                                                        implements modern energy
                                                        conservation
                                                        technologies and
                                                        strategies aimed at
                                                        ...
                                                        sources and embracing
                                                        renewable solutions, the
                                                        campus not only ensures
                                                        operational efficiency
                                                        but also upholds its
                                                    ...
                                                    <p>
                                                        ...
                                                        to sustainability
                                                        benchmarks, K.R.
                                                        Mangalam University has
                                                        submitted the necessary
                                                        data and credentials for
                                                        external scrutiny. Its
                                                        rainwater harvesting
                                                        system effectively
                                                        recharges the soil and
                                                        replenishes the
                                            ...
                                            <div className="pt-2 pb-2 text-left space-y-8">
                                                {wasteManagementData.sections.map(
                                                    (section, idx) => (
                                                        <div
                                                            key={idx}
                                                            className="space-y-4"
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-4">
                                                    {wasteManagementData.images.map(
                                                        (imgItem, idx) => (
                                                            <div
                                                                key={idx}
                                            ...
                                            <div className="pt-2 pb-2 text-left space-y-8">
                                                {waterConservationData.sections.map(
                                                    (section, idx) => (
                                                        <div
                                                            key={idx}
                                                            className="space-y-4"
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-4">
                                                    {waterConservationData.images.map(
                                                        (imgItem, idx) => (
                                                            <div
                                                                key={idx}
                                                                className="flex flex-col items-center"
                                          ...
                                          "sustain-panel-15a" ? (
                                            ...
                                            <div className="pt-2 pb-2 text-left">
                                                <div className="flex flex-wrap gap-4 pt-2">
                                                    {goodGovernanceData.reports.map(
                                                        (report, idx) => (
                                                            <Button
                                                                key={idx}
                                                                href={
                                          ...
                                          "sustain-panel-19a" ? (
                                            ...
                                            <div className="pt-2 pb-2 text-left space-y-8">
                                                ...
                                                {/* PDF Reports List */}
                                                <div className="flex flex-wrap gap-4 pt-2">
                                                    {knowledgeExchangeData.reports.map(
                                                        (report, idx) => (
                                                            <Button
                                                                key={idx}
                                                                href={
