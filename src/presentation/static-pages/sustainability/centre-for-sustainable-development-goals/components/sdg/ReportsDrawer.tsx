      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex">
          ...
          >
              ...
              {sustainTriggers.map((trigger) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left py-2 px-3.5 rounded border transition-all duration-200 cursor-pointer flex items-center ${
                      isActive
            ...
            <div className="pt-3 pb-1 flex flex-col items-start shrink-0 px-1">
              <button
                onClick={onClose}
                className="w-[56px] h-[56px] sm:w-[60px] sm:h-[60px] rounded-full bg-white text-black flex items-center justify-center hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer group shadow-xl"
