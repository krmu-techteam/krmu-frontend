...
const SdgResearchDomains: React.FC = () => {
    ...
    return (
        <div className="w-full text-white pt-8 sm:pt-10">
            ...
            <div className="mb-8">
                <h2 className="text-[20px] md:text-[22px] font-bold text-white mb-3 font-sans tracking-tight">
                ...
                <p className="text-white/90 font-poppins text-[16px] leading-[24px] text-justify font-light">
                    ...
                    Governance Model, structured across the five strategic
                    clusters of People, Prosperity, Planet, Peace, and
                    Partnership. These domains aim to generate knowledge,
                    innovation, and actionable solutions contributing to
                ...
                {sdgClusters.map((cluster) => {
                    return (
                        <div
                            ...
                            style={{
                                background:
                                    "linear-gradient(90deg, #0D7377 0%, #002D44 100%)",
                            }}
                ...
                {selectedCluster && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-[1200px] bg-white text-black rounded-[12px] p-4 md:p-5 sm:p-8 z-50 max-h-[90vh] overflow-y-auto custom-scrollbar my-auto shadow-2xl"
                        >
                            ...
                            <div className="pr-0 md:pr-10 mb-6 clear-left">
                                <h2 className="text-[20px] lg:text-[32px] font-bold text-[#1A1A1A] font-sans leading-tight mb-2">
                                    {selectedCluster.heading}
                                </h2>
                                <p className="text-[#333333] text-[14px] text-justify md:text-left md:text-[16px] font-normal leading-[22px] md:leading-[24px]">
                            ...
                            <div className="-mx-6 sm:-mx-10 px-6 sm:px-10 py-6 bg-[#F7F3E8] mb-6 w-[calc(100%+3rem)] sm:w-[calc(100%+5rem)]">
                                ...
                                <div className="w-full space-y-2 text-[#222222] text-[14px] md:text-[16px] font-normal">
                                    {selectedCluster.snapshot.map(
                                        (item, idx) => (
                                            <p
                                                key={idx}
                            ...
                            {(selectedCluster.tableTitle ||
                                ...
                                <div className="mb-3">
                                    ...
                                    {selectedCluster.tableRows &&
                                        selectedCluster.tableRows.length >
                                            0 && (
                                            <div className="overflow-x-auto w-full custom-scrollbar">
                                                <table className="w-full min-w-[650px] sm:min-w-full text-left text-xs sm:text-sm text-[#333333]">
                                                    <thead>
                                                        <tr className="bg-[#0D7377] text-white font-bold uppercase text-[11px] md:text-[12px]">
                                                        ...
                                                        {selectedCluster.tableRows.map(
                                                            (row, rIdx) => {
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        <td className="py-3.5 px-3.5 sm:px-4 font-normal text-[#1A1A1A] min-w-[280px] sm:min-w-[320px] leading-snug">
                                                                            {
                                                                                row.indicator
                                                                            }
                                                                        </td>
                            ...
                            {selectedCluster.cards &&
                                selectedCluster.cards.length > 0 && (
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        {selectedCluster.cards.map(
                                            (card, cIdx) => (
                                                <div
                                                    key={cIdx}
                                                    className="rounded-[10px] p-4 lg::p-6 border border-[#9CC89B] bg-white"
                                                >
                                                    <h4 className="text-[#1A1A1A] font-semibold text-[18px] md:text-[22px] mb-1 md:mb-3 font-font-poppins">
                                                        {card.title}
                                                    </h4>
                                                    <ul className="space-y-1 text-[#222222] text-[14px] md:text-[16px] font-normal list-disc pl-5">
                                                        {card.items.map(
                                                            (item, iIdx) => (
                                                                <li
                                                                    key={iIdx}
