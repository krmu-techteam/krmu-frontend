...
const StandingCommittee: React.FC = () => {
    ...
    return (
        <div className="pt-0 md:pt-6">
            ...
            <p className="text-white text-[14px] text-center font-light max-w-3xl mx-auto mb-6 md:mb-10 leading-relaxed">
                The university has institutional committees for
                sustainability-related initiatives, supported through the Centre
                of Excellence and SDG activities.
            </p>

            <h3 className="text-center font-bold text-white text-base sm:text-lg mb-6 md:mb-10 tracking-wide font-sans">
