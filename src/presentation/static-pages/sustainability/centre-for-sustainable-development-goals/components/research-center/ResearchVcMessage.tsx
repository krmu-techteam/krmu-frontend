    ...
    return (
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
            ...
            <div
                style={{
                    background:
                        "linear-gradient(180deg, #FFFFFF 0%, #E7C268 100%)",
                }}
                className="w-full lg:w-[489px] max-w-[489px] rounded-[10px] text-[#1A1A1A] p-4 md:p-6 sm:p-[31px] flex flex-col justify-start relative overflow-hidden shrink-0 mx-auto lg:mx-0"
            >
                <div>
                    ...
                    <div className="space-y-3.5 text-[#000000] font-poppins font-normal text-[15px] md:text-[16px] leading-[24px] tracking-normal text-justify">
                        <p>
                            ...
                            our institutional vision and everyday practices.
                            Guided by the United Nations’ Sustainable
                            Development Goals (SDGs), we are committed to
                            creating a future-ready campus that balances
                            environmental stewardship, social responsibility,
                            and academic excellence.
                        </p>
                        <p>
                            The Centre for Sustainable Development Goals at the
                            University acts as a catalyst for integrating
                            sustainability into teaching, research, and
                            community engagement. Through interdisciplinary
                            collaboration, experiential learning, and
                            innovation-driven projects, we empower our students
                            to address real-world challenges such as climate
                            change, sustainable infrastructure, and responsible
                            consumption.
                        </p>
                        <p>
                            Our campus initiatives, including energy-efficient
                            systems, water-conservation measures,
                            waste-management practices, and green
                            infrastructure, are designed to translate policy
                            into practice. More importantly, we strive to
                            cultivate a culture of sustainability where every
                            stakeholder becomes an active participant in this
                            shared journey.
                        </p>
                        <p>
                            As we move forward, K.R. Mangalam University remains
                            committed to building partnerships, fostering
                            innovation, and contributing meaningfully to the
                            global sustainability agenda. Together, we aim to
                            create not just a greener campus, but a more
            ...
            <div className="flex-1 flex flex-col gap-6">
                ...
                <div className="rounded-[20px] border-[4px] border-[#E7C268] bg-transparent p-4 md:p-5">
                    ...
                    <p className="text-white text-[15px] sm:text-[16px] leading-[24px] font-light text-justify">
                        ...
                        innovation-driven solutions, policy engagement, and
                        community-centred initiatives, thereby generating
                        measurable environmental, social, and economic
