...
import { MentorshipAchievementCard, MentorshipProgrammeInfo, MentorshipFeatures } from "@/presentation/school/components";;

const OpenSourceMentorshipSection = () => {
  return (
    <section className="relative py-10 sm:py-12 xl:py-20 text-white px-6 md:px-8 lg:px-11 2xl:px-16">
      {/* Outer card */}
      <div className="max-w-[1530px] mx-auto w-full relative rounded-sm">
        ...
        <div className="rounded-sm overflow-hidden relative z-10">
          <div className="p-2.5 sm:p-5 md:p-8 xl:p-12">
