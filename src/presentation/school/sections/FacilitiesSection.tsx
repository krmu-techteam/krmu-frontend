                        ...
                        >
                            ...
                            {slide.title && (
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex items-end p-6 md:p-8 pointer-events-none">
                                    <h3 className="text-white font-poppins font-medium text-lg md:text-xl leading-tight tracking-wide antialiased transition-colors duration-300 group-hover:text-brand-gold group-data-[active=true]:text-brand-gold">
                                        {slide.title}
                                    </h3>
                                </div>
                            )}
