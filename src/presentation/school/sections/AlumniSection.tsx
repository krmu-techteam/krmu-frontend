...
const AlumniSection = ({ title, alumniLogos, slug }: AlumniSectionProps) => {
    return (
        <section className="relative pt-10 md:pt-12 xl:pt-16 pb-10 md:pb-12 xl:pb-16">
            <div className="max-w-[1440px] mx-auto w-full text-center px-0 md:px-8 xl:px-12">
                <h2 className="heading-primary mb-4 xl:mb-8">{title}</h2>
                <div className="w-full">
                    <AlumniCarousel AluLogos={alumniLogos} slug={slug} />
                </div>
            </div>
            <SectionDivider />
        </section>
