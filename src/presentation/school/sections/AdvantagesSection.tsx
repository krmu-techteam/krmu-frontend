...
const AdvantagesSection = ({
    ...
    return (
        <section
            id="advantage"
            className="py-10 md:py-12 xl:py-20 bg-transparent relative z-10 font-poppins text-white scroll-mt-28"
        >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 items-start">
                            {advcards.map((advcard, index) => {
                                const iconSrc = advcard?.cardimg?.url
                                    ...
                                    : LOCAL_ADVANTAGE_ICONS[
                                          index % LOCAL_ADVANTAGE_ICONS.length
                                      ];
