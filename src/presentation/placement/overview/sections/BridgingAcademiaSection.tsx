...
const BRIDGING_CARDS = [
    {
        ...
        alt: "Industry practical training and corporate MoU partnerships at K.R. Mangalam University",
        description:
    ...
    },
    {
        ...
        alt: "Project-Based Learning and student research projects at K.R. Mangalam University",
        description:
    ...
    },
    {
        ...
        alt: "Corporate in-house training and internship experience for KRMU graduates",
        description:
    ...
    return (
        <section className="relative z-5 py-12 md:py-16 px-6 md:px-8 xl:px-16 max-w-[1530px] mx-auto">
            ...
            <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
                <h2 className="heading-primary text-center mb-4 sm:mb-6">
                    Bridging Academia and Industry
                </h2>
                <p className="font-poppins text-white text-sm sm:text-base md:text-[16px] leading-relaxed font-light">
                    Benefit from our strong ties with leading corporations and
                    startups. Our partnerships not only bring in expert speakers
                    but also open doors for internships and real-world projects,
            ...
            <div className="flex flex-col gap-6 sm:gap-8 max-w-[1240px] mx-auto">
                {BRIDGING_CARDS.map((card, index) => (
                    <div
                        key={index}
                        className="border border-[#999999] rounded-[10px] p-3 flex flex-col md:flex-row items-center gap-5 sm:gap-8"
                    >
                        {/* Image Box */}
                        <div className="relative w-full md:w-[48%] lg:w-[45%] h-[200px] sm:h-[260px] md:h-[300px] rounded-[10px] overflow-hidden shrink-0">
                            <Image
                                src={card.image}
                                fill
                        ...
                        <div className="w-full md:w-[52%] lg:w-[55%] flex flex-col justify-center text-left py-2 sm:py-4">
                            <h3 className="text-xl sm:text-[22px] font-bold font-poppins text-white mb-2 sm:mb-3 tracking-wide">
                                {card.title}
                            </h3>
                            <p className="font-poppins text-white/90 text-xs sm:text-sm md:text-[16px] leading-relaxed font-light">
                                {card.description}
                            </p>
                        </div>
                    </div>
