const PlacementPreparationSection = () => {
 
  return (
    <section className="pb-[60px] px-4">
      <div className="max-w-[1530px] mx-auto w-full lg:flex gap-[30px]">
        <div className="lg:w-1/2 p-10 md:p-[30px] bg-[#061623] font-poppins rounded-[4px] text-white mb-5 lg:mb-0">
        ...
        <div className="lg:w-1/2 p-10 md:p-[30px] bg-[#061623] font-poppins rounded-[4px] text-white placementulli">
...
export default PlacementPreparationSection;
