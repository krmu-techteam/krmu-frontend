        ...
        <>
            ...
            <div className="hidden lg:flex fixed right-0 top-1/2 -translate-y-1/2 flex-col gap-1 z-[9999] font-poppins w-[40px] items-end">
                ...
                <a
                    ...
                    className="!bg-[#27AB00] hover:!bg-[#27AB00] !text-white w-[40px] h-[40px] min-w-[40px] max-w-[40px] p-0 box-border flex items-center justify-center transition-all duration-300 rounded-l-[2px] group relative shrink-0"
                    title="WhatsApp Us"
                >
                    <FaWhatsapp size={22} className="!text-white" />
                    <span className="absolute right-full mr-2 !bg-[#27AB00] !text-white text-[13px] font-medium py-1.5 px-3 rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap shadow-md">
                        Chat on WhatsApp
                    </span>
                </a>
            </div>
