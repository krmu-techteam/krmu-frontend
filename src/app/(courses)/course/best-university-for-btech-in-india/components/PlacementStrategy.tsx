      ...
      <div className="max-w-[1269px] mx-auto w-full text-center">
        <div className="mb-12">
          ...
          <p className="compare-subheading">
            K.R. Mangalam University, considered as the best private university
            in India for B.Tech. by many students, lays emphasis not only on
            conceptual clarity but career-readiness as well. Our multifaceted
            approach ensures you are well-prepared for the professional world.
          </p>
        </div>
