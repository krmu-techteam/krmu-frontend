    ...
    <section className="courseheroSection">
      <div className="px-4 md:px-12 z-50 py-10 flex flex-col lg:flex-row justify-between items-center relative">
        <div className="w-full lg:w-1/2 xl:w-2/5">
          <div className="flex justify-center sm:justify-start flex-wrap sm:flex-nowrap gap-2 mb-3">
          ...
          <h1 className="text-white text-center sm:text-left font-semibold mb-3 leading-[1.5] text-3xl  lg:text-5xl 2xl:text-[46px]">
            ...
            <br />
            The Best Private University for B.Tech. in India
          </h1>
          <p className="text-white mb-6 hidden sm:block">
            KRMU, among the best universities in India for B.Tech. CSE strives
            for holistic development of every student via its comprehensive
            curriculum, expert faculty & modern infrastructure!
          </p>
        ...
        <div
          className="w-full lg:w-1/2 xl:w-3/5 mt-5 sm:mt-0 scroll-mt-28 lg:scroll-mt-32"
          id="apply-section"
        >
