        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="ncr-benefit-card h-full">
            ...
            <p className="benefit-text">
              ...
              Students seeking B.Tech. computer science and engineering
              admission in Gurugram gain strong placement exposure, internships,
              industry projects, and recruitment access from leading companies
              for high-growth engineering careers.
            </p>
          </div>
