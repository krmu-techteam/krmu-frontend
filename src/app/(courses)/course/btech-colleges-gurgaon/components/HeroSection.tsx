    ...
    <section className="courseheroSection">
      <div className="px-4 md:px-12 z-50 py-10 flex flex-col lg:flex-row justify-between items-center relative">
        <div className="w-full lg:w-1/2 xl:w-1/3">
          ...
          <h1 className="text-white text-center sm:text-left font-semibold mb-3 leading-[1.5] text-3xl  lg:text-5xl 2xl:text-[46px] w-full lg:w-[111%]">
            Admissions Open At KRMU!
            <br />
            One Of The Best
            <br />
