        ...
        <div className="mb-12 text-center">
          <h3 className="text-2xl md:text-4xl font-semibold mb-5">
            ...
            <span className="text-[#e31e24]">
              Best B.Tech. Colleges in Gurgaon?
            </span>
          </h3>
          <p className="mb-4">
            Learn & Launch Your Engineering Career with one of the best private
            colleges in Gurgaon for B.Tech. at India’s Fastest-Growing Tech
            Ecosystem.
          </p>
        </div>
