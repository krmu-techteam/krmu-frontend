      ...
      <div className="max-w-[1296px] mx-auto w-full flex flex-col lg:flex-row gap-5">
        <div className="w-full lg:w-1/2 max-w-[540px] mx-auto">
          ...
          <p className="loan-desc mt-6 mb-4">
            Ranking among the best private B.Tech. Colleges in Haryana​, K.R.
            Mangalam University has partnered with top banks to offer Education
            Loans with a moratorium period. Repayment starts either one year
            after course completion or six months after securing a job
