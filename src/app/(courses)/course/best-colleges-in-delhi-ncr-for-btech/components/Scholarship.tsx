      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mx-auto max-w-[900px] text-gray-600 mt-4">
            Touted as one of the top colleges for B.Tech. in Delhi NCR, K.R.
            Mangalam University is deeply committed towards the motto of making
            quality education accessible to all. Our robust scholarship
            programmes are designed to reward academic excellence, promote
            talent, and provide monetary assistance to deserving students.
          </p>
        ...
        <div className="bg-[#0060aa] rounded-[30px] p-[50px_30px] text-center shadow-[0_20px_40px_rgba(1,49,107,0.2)] relative overflow-hidden">
          ...
          <p className="text-white/90 text-[18px] max-w-[800px] mx-auto mb-6">
            KRMU rewards talent with up to 100% scholarships across merit,
