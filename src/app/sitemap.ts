...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const newsEventsUrls: MetadataRoute.Sitemap = newsevents.map(
        (newsevent) => ({
    ...
    const photoGalleriesUrls: MetadataRoute.Sitemap = photoGalleries.map(
        (p) => ({
    ...
    return [
        ...
        {
            url: `${baseUrl}/centre-for-sustainable-development-goals-2`,
            changeFrequency: "monthly",
            priority: 0.7,
        },
        {
