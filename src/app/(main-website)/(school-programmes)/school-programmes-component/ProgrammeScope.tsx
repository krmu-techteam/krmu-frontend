        ...
        <section className=" py-8 md:p-6 lg:p-10 xl:py-12 2xl:py-16">
            <div className="max-w-[1440px] mx-auto flex flex-col sm:flex-row items-center gap-6 xl:gap-8 2xl:gap-10 px-4 md:px-0 lg:px-0 2xl:px-0">
                ...
                <div className="w-full sm:w-1/2 sm:text-left text-justify text-white">
                    <h2 className="text-2xl text-center sm:text-left sm:text-2xl md:text-[28px] lg:text-[32px] xl:text-[40px] 2xl:text-[50px] font-semibold md:font-bold leading-tight mb-3 xl:mb-3 2xl:mb-5">
