      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 w-full flex flex-col items-center">
        ...
        <div className="relative w-full mx-auto">
          ...
          <Image
            ...
            fill
            className="-mb-10 object-contain md:translate-y-[20%] lg:translate-y-[42%] xl:translate-y-[33%] 2xl:translate-y-[30%] transform scale-[1.25] lg:scale-[1.2] xl:scale-[1] translate-x-[4px] translate-y-[110px] md:translate-y-[120px]"
