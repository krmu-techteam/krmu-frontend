...
const ScholarshipBanner = () => {
  return (
    <section className="w-full py-10 lg:py-16 px-4 sm:px-6 lg:px-8 max-w-[1217px] mx-auto">
      {/* Dark Navy Card Container (1217px max-width, 329px min-height, #0B1823 background) */}
      <div className="relative w-full bg-[#0B1823] rounded-[4px] lg:rounded-[6px] min-h-[329px] flex items-center p-6 sm:p-10 lg:px-14 lg:py-8 overflow-visible shadow-xl">
        {/* Left Content Area */}
        <div className="w-full lg:max-w-[580px] z-10 py-2">
          ...
          <p className="font-poppins text-xs sm:text-sm text-gray-300 leading-relaxed max-w-lg mt-4">
