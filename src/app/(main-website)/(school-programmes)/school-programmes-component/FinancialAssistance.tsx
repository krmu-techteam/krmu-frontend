    ...
    <section className="prog-global-padding py-8 md:p-6 lg:py-10 xl:py-10 2xl:py-16 px-4 lg:px-10 2xl:px-0">
      <div className="max-w-[1440px] mx-auto w-full">
        ...
        <div className="common-prog-container !max-w-7xl">
          <h2 className="heading-primary mb-3 md:mb-4">
            {heading}{" "}{highlightheading} 
          </h2>
          <p className="text-[15px] sm:text-[16px] text-justify md:text-[17px] font-poppins text-white/90 px-0 sm:px-0 md:px-12 lg:px-24 xl:px-36 md:mb-0">{description}</p>
        </div>
        ...
        {/* Logos Grid */}
        <div className="mt-6 md:mt-8 lg:mt-12 2xl:mt-16 flex items-center justify-center">
