      ...
      <div className="flex items-center justify-center">
        ...
        {admisbtn && slug !== "bhmct-hotel-management" && (
          <button
            ...
            } text-white bg-[#cb000d] hover:bg-[#c42518] w-fit px-8 py-2.5 flex items-center justify-center gap-3 rounded-md font-semibold mt-8 cursor-pointer tracking-[0.025em] text-lg shadow-md hover:shadow-xl transition-all duration-300 group relative overflow-hidden`}
          >
