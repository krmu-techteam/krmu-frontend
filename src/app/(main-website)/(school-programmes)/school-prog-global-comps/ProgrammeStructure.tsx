              ...
              />
                    ...
                    `}
                            ...
                            {(() => {
                                ...
                                return (
                                    <div className="pt-4 pb-2 md:py-6 xl:py-8 font-poppins bg-transparent flex flex-row items-center md:justify-start justify-center gap-4 md:gap-4 overflow-x-auto no-scrollbar w-full">
