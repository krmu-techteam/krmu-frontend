        ...
        <section className="bg-[url(/placements/contact-bg.webp)] bg-no-repeat bg-cover bg-center py-[30px] px-4">
            <div className="max-w-[1664px] mx-auto lg:flex">
                <div className="lg:w-1/2 text-[#3d5fa5]">
                    ...
                    <p className="mb-5">
                        For further information or to get involved with our
                        research endeavours, please contact our research
                        department:
                    </p>
                    <p className="mb-10">
                    ...
                    <ul>
                        <li className="flex gap-3 mb-5">
                            ...
                            <span className="flex flex-col">
                                <Link href="tel:+91-9289143055">
                                    (+91)-9289-1430-55
                                </Link>
                                <Link href="tel:+91-8800697009">
                                    (+91)-8800-6970-09
                                </Link>{" "}
                            </span>
                        </li>
                    ...
                    <div className="flex gap-10 flex-wrap">
                        <Link
                            href="https://dst.gov.in/call-for-proposals"
                            target="_blank"
