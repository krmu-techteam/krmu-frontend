...
const ProgrammesOurLocation = () => {
  return (
    <section className="py-[50px] px-2.5 sm:px-11">
      <div className="max-w-[1530px] mx-auto w-full p-4 md:p-12 bg-white/[0.02] rounded-sm sm:flex gap-3 md:gap-6 text-center sm:text-left">
        <div className="sm:w-5/12">
          <Image
            src="/programmes/cyber-city.webp"
            width={486}
            height={418}
            className="w-full h-full border-[10px] border-white/[0.2] rounded-md object-cover"
            alt={"Our Location"}
          />
        </div>
        <div className="sm:w-7/12 pt-6 sm:px-3">
          ...
          <Image
            ...
            width={608}
            height={258}
            className="w-full h-auto border-[10px] border-white/[0.2] rounded-md inline-block"
          />
        </div>
      </div>
    </section>
