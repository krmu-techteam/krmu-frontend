...
const ClubsSocieties = () => {
    return (
        <section className=" flex justify-center h-[1200px] md:h-[1000px] lg:h-[1070px] xl:h-[1000px] 2xl:h-[1000px]  py-4 sm:py-12 px-4 sm:px-12 bg-cover bg-[55%] sm:bg-[45%] lg:bg-[25%] xl:bg-center bg-no-repeat bg-[url(https://truthful-cabbage-82fd27e8f6.media.strapiapp.com/Rectangle_1403_e55adcc5a7.jpg)]">
            {/* <Image
      ...
      /> */}
            ...
            >
                ...
                >
                    KRMU offers a vibrant campus life to students and faculty.
                    From cultural events to scientific experiments, from robotic
                    developments to artistic pursuits, students at KRMU maintain
                    their enthusiasm and actively participate in a wide range of
                    activities. The university supports more than thirteen clubs
                    and societies, which are primarily run by students. These
                    clubs and societies offer students a platform to showcase
                    their talents and develop new skills while encouraging
                    creative and out-of-the-box thinking. A wide range of
                    activities is organised to help students develop new skills,
                    nurture their talents, and pursue their interests beyond the
                    classroom.
                </p>
