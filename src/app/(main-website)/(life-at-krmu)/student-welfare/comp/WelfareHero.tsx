        ...
        <section className="bg-[#051630] pt-[108px] sm:pt-[85px] xl:pt-[115px] overflow-hidden ">
            ...
            <div className=" mx-auto  bg-[linear-gradient(97.3deg,#001732_70.09%,#004698_100%)] px-4 sm:px-10 pb-8 sm:pb-12">
                <div className="flex justify-center items-center text-center flex-col max-w-[1550px] mx-auto w-full text-white welfare_desg_int">
                    ...
                    >
                        <p>
                            The Department of Student Welfare (DSW) is committed
                            to creating a supportive, inclusive, and
                            student-friendly campus environment. It focuses on
                            students&rsquo; academic, social, and personal
                            well-being through cultural activities, workshops,
                            awareness programmes, and student engagement
                            initiatives.
                        </p>
                        <p>
                            The department also works closely with the Student
                            Council and student bodies to encourage
                            participation, leadership, and effective
                            communication between students and the institution.
                            DSW continues to support and guide students
                            throughout their academic journey while promoting a
                            vibrant and empowering campus culture.
                        </p>
                    </div>
