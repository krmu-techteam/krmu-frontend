...
const welfareCards = [
    {
        ...
        image: "https://truthful-cabbage-82fd27e8f6.media.strapiapp.com/Rectangle_1384_8b424ae885.jpg",
    ...
    },
    {
        ...
        image: "https://truthful-cabbage-82fd27e8f6.media.strapiapp.com/Rectangle_1385_2248d2fe13.jpg",
    ...
    },
    {
        ...
        image: "https://truthful-cabbage-82fd27e8f6.media.strapiapp.com/Rectangle_1386_556a9bf949.jpg",
        ...
        <section className="bg-white px-4 pb-12 md:px-10 lg:px-12">
            <div className="relative mx-auto w-full max-w-[1550px] overflow-hidden rounded-md bg-[linear-gradient(180deg,#001732_0%,#994246_100%)] px-6 pb-8 pt-10 text-white md:px-[65px] md:pb-[60px] md:pt-[82px]">
                ...
                <div className="relative z-10 grid  lg:grid-cols-[57%_43%] lxl:grid-cols-[60%_40%]">
                    <div className="mb-10">
                        ...
                        <div className="mt-5 flex max-w-[750px] gap-5">
                            ...
                            >
                                At K.R. Mangalam University, we are guided by a
                                compelling vision and mission that form the
                                cornerstone of our educational ethos. Our
                                approach is not just about imparting knowledge;
                                it is about shaping the future leaders of the
                                world. With a vision deeply rooted in the
                                comprehensive development of each individual, we
                                strive to create a nurturing environment that
                                fosters academic excellence, personal growth,
                ...
                <div className="relative z-20  grid gap-3 lg:grid-cols-2 md:gap-2 ">
                    <article className="rounded-md  bg-[linear-gradient(180deg,#E7C268_0%,#FFFFFF_100%)] pb-7 text-black">
                        ...
                        >
                            Student Welfare envisions the holistic development
                            of students by providing life skills and counselling
                            services, thereby preparing them for a diverse,
                            enterprising, and global society.
                        </p>
                    </article>
                    ...
                    <article className="rounded-md  bg-[linear-gradient(180deg,#E7C268_0%,#FFFFFF_100%)] pb-7 text-black">
                        ...
                        <p
                            className={`${poppins.className} px-6 pt-3 text-justify text-[13px] sm:text-[18px] font-normal leading-[1.45] md:px-[50px]`}
                        >
                            The Student Welfare Department aims to facilitate
                            global leadership and personal well-being through
                            high moral values and sound life skills among
                            students.
                        </p>
                    </article>
                </div>
            ...
            <div className="flex flex-wrap lg:flex-row justify-center pt-12 mx-auto  w-full max-w-[1550px] gap-6 ">
                {welfareCards.map((card) => (
                    <article
                        key={card.title}
                        className={`${card.bgClass} ${card.textClass} w-fit lg:w-[450px] xl:w-[430px] [@media(min-width:1640px)]:w-[500px] h-fit xl:h-[712px] overflow-hidden rounded-xl  p-2.5 shadow-[0_16px_35px_rgba(15,23,42,0.08)]`}
                    >
