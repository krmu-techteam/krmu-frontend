            ...
            <div className="mx-auto w-full max-w-[1550px] overflow-hidden rounded-md bg-[linear-gradient(165deg,#A598BF_6%,#120032_13.48%)] px-6 py-8 text-white  md:px-8 md:py-9 lg:px-9">
                ...
                <span className="block h-[46px] w-[18px] rotate-[16deg] rounded-full bg-[#2f8cff] md:h-[60px] md:w-[20px]" /> */}
                            ...
                            <p className="max-w-[1060px] text-justify text-[14px] py-2 pt-2 sm:pt-0 md:pt-10  font-normal tracking-[1%] text-white md:text-[18px] ">
                                Dear Students, <br />
                                Welcome to a vibrant community of learning,
                                innovation, and endless opportunities. Your
                                university journey is not just about earning a
                                degree but about discovering your potential,
                                building resilience, and shaping values that
                                will guide you throughout life. At the
                                Department of Student Welfare, we are committed
                                to fostering your holistic growth—academic,
                                personal, cultural, emotional, and
                                social—through a supportive and inspiring campus
                                environment. We encourage you to actively
                                participate in academics, leadership
                                initiatives, co-curricular activities, and
                                community engagement, as every experience will
                                help you grow into confident, compassionate, and
                                future-ready individuals. Dream fearlessly,
                                learn passionately, and lead with integrity,
                                because the world needs your ideas, energy,
