            ...
            <section className="bg-[#F0F3F9] px-4 sm:px-6 md:px-12 py-12">
                <div className="mx-auto w-full max-w-[1550px]">
                    ...
                    <div className="flex flex-col xl:flex-row items-center gap-6 rounded-2xl border-4 border-white bg-[#EDF5FF] px-4 md:gap-10 md:px-8 py-4 sm:py-12  shadow-sm">
                        ...
                        >
                            The K.R. Mangalam University Student Council serves
                            as the representative body of the student community,
                            acting as a vital link between students and the
                            university administration. Working under the
                            Department of Student Welfare, the Council advocates
                            for student interests, addresses student concerns,
                            and contributes to the development of a vibrant and
                            inclusive campus environment. Through student
                            engagement activities, the Council encourages active
                            participation, leadership, teamwork, creativity, and
                            democratic values. The Student Council strives to
                            create a supportive, dynamic, and memorable
                            university journey for all students.
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <div className={`${poppins.className}`}>
                                <p className="text-justify text-sm leading-[1.85] font-normal text-[#000000] md:text-[18px]">
                                    Being recognised as the Best Student Council
                                    Member is truly an honour and a moment of
                                    immense gratitude. This achievement is not
                                    just mine but a reflection of the constant
                                    support, guidance, and teamwork shared by my
                                    fellow council members and the Department of
                                    Student Welfare.
                                </p>
                                <br />
                                <p className="text-justify text-sm leading-[1.85] font-normal text-[#000000] md:text-[18px]">
                                    My journey in the Student Council has been a
                                    learning experience filled with
                                    opportunities to lead, collaborate, and
                                    contribute meaningfully to the student
                                    community. It has helped me grow both
                                    personally and professionally, shaping my
                                    perspective and strengthening my sense of
                                    responsibility.
                                </p>
                                <br />
                                <p className="text-justify text-sm leading-[1.85] font-normal text-[#000000] md:text-[18px]">
                                    I am sincerely thankful for the trust placed
                                    in me, and I remain committed to continuing
                                    my efforts towards creating a more engaging,
