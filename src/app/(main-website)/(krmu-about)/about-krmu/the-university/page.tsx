...
import PioneerExcellence from "@/app/(main-website)/components/PioneerExcellence";
                ...
                <div className="max-w-[1440px] mx-auto w-full">
                    <div className="flex flex-wrap md:flex-nowrap">
                        <div className="w-full md:w-3/5">
                            ...
                            <BlocksRenderer
                                content={
                                    aboutData?.internationcollaboration
                                        ?.description
                                }
                            />
                            {(aboutData?.internationcollaboration?.intcollabbtn
                                ?.buttonlink ||
                                aboutData?.internationcollaboration
                                    ?.intcollabbtn?.buttonclass) && (
                                <Link
                                    href={
                                        aboutData?.internationcollaboration
                                            ?.intcollabbtn?.buttonlink
                                    }
