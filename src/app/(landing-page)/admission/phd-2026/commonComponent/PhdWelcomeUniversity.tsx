    ...
    <section className="py-10 bg-[#F8F9FA] px-4">
      <div className="max-w-[1300px] mx-auto w-full flex flex-col xl:flex-row gap-10">
        <div className="w-full xl:w-1/3">
          ...
          <p className="my-5">
            K.R. Mangalam University has steadily emerged as a leading hub of
            education, research, and innovation in the Delhi NCR region.
            Established under the Haryana Private Universities Act, the
            University is NAAC ‘A’ accredited, reflecting its commitment to high
            standards of academic excellence, governance, and institutional
            quality.
          </p>
          <p className="mb-5">
            The University offers over 100 undergraduate, postgraduate, and
            doctoral programmes across diverse disciplines. Backed by the legacy
            of the prestigious K.R. Mangalam Group, KRMU emphasises research-led
            learning, industry relevance, and global exposure.
          </p>
          <p className="mb-5">
            With modern infrastructure, experienced faculty, international
            collaborations, and strong industry partnerships, K.R. Mangalam
            University provides a dynamic and future-ready academic
            environment—preparing students to succeed in an increasingly
        ...
        <div className="w-full xl:w-1/3 flex flex-col gap-5 text-center sm:text-left md:gap-x-10 md:gap-y-20">
          <div className="grid grid-cols-2">
            ...
            <div className="flex flex-col">
              <h4 className="text-2xl sm:text-3xl text-[#005DA9] font-semibold">
                12,000+{" "}
              </h4>
