                    ...
                    <td className="px-4 py-4 text-sm border border-gray-200">
                      3 Years (Minimum)
                        ...
                        <p className="leading-[1.5] mb-5">
                            The Ph.D. programme offered by K.R. Mangalam
                            University is framed according to standards set by
                            University Grants Commission (UGC) under the able
                            guidance of highly qualified and widely recognised
                            faculty in their respective domains. We offer both
                            full time and part time Ph.D. programmes in a wide
                            range of domains. You will work closely with your
                            supervisor on a research problem and push the
                            frontiers of human knowledge and understanding.
                        </p>
                        <p className="mb-5">
                            K.R. Mangalam University has a well-established
                            eco-system for impactful Research, Development and
                            Innovation. We have a rich Central Instruments
                            Facility (CIF) pertaining to Materials Science and
                            Pharmacology related Research activities, in
                            particular. You may get an opportunity to work in
                            some of the Publicly Funded R&D
                            Institutes/Laboratories and other Higher Education
                            Institutes (HEIs).
                        </p>
                        <p>
                            Come and join us in the exciting and thrilling world
                            of Research, Development and Innovation and become
                            part of University’s endeavour in achieving the goal
                            of Atma Nirbhar Bharat and contribute to solving
                            Society’s problems.
                        </p>
                    </div>
                    <div className="w-full lg:w-1/2">
