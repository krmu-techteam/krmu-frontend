          ...
          <div className="flex flex-col gap-6 h-full">
            <div className="bg-[#0161B0] rounded-2xl px-4 pb-2 pt-6 sm:p-8 md:p-10 flex items-end min-h-60 sm:min-h-70 flex-1">
              <div>
                ...
                <p className="mt-3 text-sm sm:text-base font-medium text-[#E0E7FF] leading-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 flex-1">
              <div className="bg-[#DAE2FD] rounded-xl p-6 sm:p-7 md:p-8 h-full">
                ...
                <p className="mt-3 text-sm md:text-[13px] text-[#000000] leading-5">
                  Design creator led properties — channels, newsletters, shows
                  or communities — and learn how to grow and engage audiences
                  around them.
                </p>
              </div>
              ...
              <div className="bg-[#DAE2FD] rounded-xl p-6 sm:p-7 md:p-8 h-full">
                ...
                <p className="mt-3 text-sm md:text-[13px] text-[#000000] leading-5">
                  ...
                  campaigns, content calendars and creator collaborations for
        ...
        {showAll && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
            <div className="bg-[#DAE2FD] rounded-xl p-6 sm:p-7 md:p-8 h-full">
              ...
              <p className="mt-3 text-sm md:text-[13px] text-[#000000] leading-5">
                Work in teams to conceptualise, shoot and edit short films or
                OTT style pilots, trailers or digital series concepts.
              </p>
            </div>
            <div className="bg-[#DAE2FD] rounded-xl p-6 sm:p-7 md:p-8 h-full">
              <BarChart3 className="w-6 h-6 text-purple-700" />
            ...
            <div className="bg-[#DAE2FD] rounded-xl p-6 sm:p-7 md:p-8 h-full">
              ...
              <p className="mt-3 text-sm md:text-[13px] text-[#000000] leading-5">
                Design and build a real digital media or content venture – a
                show, a micro agency, a niche media brand or a product around
                content.
              </p>
            </div>
            <div className="bg-[#DAE2FD] rounded-xl p-6 sm:p-7 md:p-8 h-full">
              ...
              <p className="mt-3 text-sm md:text-[13px] text-[#000000] leading-5">
                Complete internships with news channels, digital newsrooms,
                agencies, production houses or content teams in Delhi NCR and
                beyond.
              </p>
            </div>
          </div>
