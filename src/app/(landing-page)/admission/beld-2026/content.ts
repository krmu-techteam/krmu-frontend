...
export const industryExperts: IndustryExpertsSection = {
    ...
    cards: [
        {
            imgUrl: "https://krmangalam.edu.in/admission/mba-2025/assets/images/apple.svg",
            alt: "Apple Logo",
    ...
    testimonials: [
        {
            ...
            quote: "My research at K.R. Mangalam University on social media's influence in modern society has been incredibly fulfilling. The mentorship and focus on real-world change truly set this programme apart.",
        },
        {
            id: 2,
            name: "Prerna Singh",
            ...
            quote: "The encouragement and diverse opportunities I received throughout my PhD at KRMU were beyond my expectations.",
        },
        {
            id: 3,
            name: "Rajeev Kumar",
            ...
            quote: "KRMU's expert faculty guidance pushed me to achieve much more than I believed possible.",
        },
    ],
};
...
export const faqSectionData: FAQSectionData = {
    ...
    faqs: [
        ...
        },
        {
            id: "item-2",
            question:
                "How can I get a scholarship at K.R. Mangalam University?",
