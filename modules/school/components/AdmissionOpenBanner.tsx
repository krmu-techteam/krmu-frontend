    ...
    <section className="w-full relative z-20 py-6 lg:py-8">
      <div className="max-w-[1530px] mx-auto px-5 sm:px-3 py-4 sm:py-3 flex flex-col md:flex-row items-center justify-between gap-6 bg-[linear-gradient(90deg,#8B3D22_11.06%,#003763_100%)] rounded-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <Link
            href="/programmes"
            className="inline-flex font-poppins items-center justify-center border border-white/60 px-5 py-2.5 text-base sm:text-md font-medium text-white rounded-sm whitespace-nowrap hover:bg-white/10 transition-colors"
          >
          ...
          {(admBtn?.buttonlink || admBtn?.buttonclass) && (
            <Link
              ...
              className={`inline-flex items-center justify-center border border-[#CB000D] bg-[#CB000D] hover:bg-[#CB000D] px-6 py-2.5 text-base sm:text-md font-medium font-poppins text-white rounded-sm whitespace-nowrap transition-all relative overflow-hidden group ${admBtn.buttonclass || ""}`}
              target="_blank"
