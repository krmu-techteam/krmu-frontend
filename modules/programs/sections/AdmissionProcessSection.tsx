...
import { AdmissionProcessSectionProps } from "../types";
...
const AdmissionProcessSection = ({
  ...
  return (
    <section className="relative z-10 prog-global-padding py-8 md:p-6 lg:py-12 2xl:py-16 px-4 lg:px-10 2xl:px-0">
