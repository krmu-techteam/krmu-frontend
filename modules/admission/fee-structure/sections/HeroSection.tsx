...
const HeroSection = ({ feeStructHero }: Props) => {
  return (
      ...
      <div className="text-center max-w-[1600px] mx-auto w-full">
        ...
        {feeStructHero?.fee_structure_url && (
          <Link
            ...
            className="inline-flex items-center justify-center bg-[#0062aa] text-white text-sm md:text-[15px] font-light tracking-wide px-8 py-3 rounded-[2px] hover:bg-[#02345a] font-poppins transition-all duration-300 whitespace-nowrap"
          >
            Explore Programmes
          </Link>
        )}
