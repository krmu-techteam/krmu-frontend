...
const ProgrammesExplorer = () => {
  ...
  return (
    <section className="w-full px-4 md:px-5 2xl:px-0 font-poppins">
      ...
      >
        <div 
          className="w-full max-w-4xl max-h-[90vh] relative shadow-2xl rounded-md overflow-hidden border border-white/10 flex flex-col bg-[#0B1221]"
        >
          {/* Decorative Backgrounds */}
          <div className="absolute inset-0 pointer-events-none z-0">
            <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] opacity-40 blur-[100px]" style={{ background: "url('/blue-bg.png') center/cover" }}></div>
            <div className="absolute bottom-[-20%] right-[-10%] w-[70%] h-[70%] opacity-30 blur-[100px]" style={{ background: "url('/yellow-bg.png') center/cover" }}></div>
            <div className="absolute inset-0 opacity-[0.03]" style={{ background: "url('/bg-noise.png') repeat", backgroundSize: "50px" }}></div>
          </div>
                ...
                <div className="flex flex-col gap-4 mt-4">
                  <div className="flex items-start gap-3">
                    <div className="shrink-0 flex items-center justify-center mt-0.5">
                      <Check className="text-[#00AEEF]" size={20} strokeWidth={3} />
                    </div>
