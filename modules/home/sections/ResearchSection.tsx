      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-0 items-start relative xl:h-[750px]">
          ...
          <div className="w-full lg:w-[58%] xl:w-[925px]">
            ...
            <div className="grid grid-cols-2 max-w-2xl px-4 lg:px-0 xl:max-w-[600px] xl:mx-16">
              {RESEARCH_STATS.map((stat, i) => {
                ...
                return (
                  <div key={i} className={`flex flex-col justify-center items-center ${borderClass}`}>
                    ...
                    <p className="text-white/70 text-sm md:text-base leading-snug whitespace-pre-line text-center">{stat.label}</p>
                  </div>
                );
              })}
            </div>
          ...
          <div className="w-full lg:w-[47%] lg:-ml-[5%] lg:mt-16 xl:absolute xl:left-[728px] xl:top-[192px] xl:w-[557px] xl:h-[557px] xl:m-0 z-20">
            <div className="bg-brand-navy border-12 border-brand-dark p-10 md:p-14 xl:p-12 rounded-[4px] h-full shadow-2xl backdrop-blur-xl flex flex-col justify-center">
