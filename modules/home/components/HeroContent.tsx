  ...
  return (
    <div className="absolute top-1/2 -translate-y-[60%] left-0 w-full px-6 md:px-16 lg:px-24 z-20 text-white">
      <div className="max-w-4xl w-full">
        <p 
          className="text-[16px] sm:text-[20px] md:text-[24px] lg:text-[30px] font-normal tracking-tight mb-4 leading-tight opacity-95"
          style={{ textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}
        >
          Discover the world of possibilities with<br className="hidden sm:inline" />
          K.R. Mangalam University where
        </p>
        <h1 
        ...
        <Link href="/about-us" className="inline-flex items-center gap-2.5 text-[14px] md:text-[16px] font-medium group/btn cursor-pointer relative overflow-hidden group">
