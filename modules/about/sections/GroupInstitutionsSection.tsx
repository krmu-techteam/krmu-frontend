    ...
    <section className="relative py-6 md:py-8 lg:py-12 xl:py-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-12 xl:px-16">
        <div className="text-center max-w-[1200px] mx-auto mb-10 lg:mb-14">
          ...
          <h4 className="text-white text-[16px] text-pretty lg:text-center font-poppins md:text-lg font-semibold leading-[1.5] mb-5 px-16 lg:px-0">
            {subtitle}
          </h4>
          <p className="text-white/85 text-justify lg:text-center font-poppins text-[16px] lg:text-[16px] leading-[1.9]">
            {description}
          </p>
        </div>
        <div>
