...
const ClubsSocieties = () => {
  return (
    <section className="relative h-[800px] py-8 bg-contain bg-[url(https://truthful-cabbage-82fd27e8f6.media.strapiapp.com/Rectangle_1403_e55adcc5a7.jpg)]">
      {/* <Image
      ...
      <div
        className={` absolute left-4 right-4 top-8 rounded-md bg-[linear-gradient(180deg,#E7C268_0%,#FFF3D7_100%)] px-6 py-6 text-[#001732] shadow-[0_18px_45px_rgba(15,23,42,0.12)] backdrop-blur-[1px] md:left-12 md:right-12 md:top-10 md:px-8 md:py-7`}
      >
        <h2
