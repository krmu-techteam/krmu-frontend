...
const ReadMoreText = ({
  ...
  if (text.length <= limit)
    return <p className="leading-relaxed text-gray-700 text-lg">{text}</p>;
...
const AchievementReadMore = ({
  ...
  if (text.length <= limit)
    return <p className="text-gray-600 leading-relaxed text-[15px]">{text}</p>;
    ...
    <div>
      <p
        ...
        dangerouslySetInnerHTML={{
          __html: isExpanded ? text : `${text.slice(0, limit)}...`,
        }}
      />
      ...
      <div className="max-w-[1440px] mx-auto w-full">
        ...
        <div className="mb-12 md:mb-16 text-center">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-5xl mx-auto">
            ...
            fitness. It instils values such as teamwork, discipline, resilience,
            and sportsmanship, all of which are integral to personal and
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 mb-12 md:mb-16">
          ...
          <div className="group flex flex-col rounded-[2px] overflow-hidden border border-gray-100 bg-gradient-to-b from-gray-50 via-blue-50/20 to-gray-50 transition-all duration-500">
            ...
            <div className="p-8 md:p-10 flex flex-col flex-grow">
              <ReadMoreText
                text={`K.R. Mangalam University goes beyond inter-college sports events with its own internal competition, "SPORTURA". Exclusive to KRMU students, SPORTURA is a vibrant inter-school sports event that annually attracts over 1,000 participants from a wide range of schools. Here, students have the opportunity to showcase their sporting prowess in cricket, football, basketball, volleyball, tennis, badminton, chess, etc. SPORTURA serves as a testament to the university's commitment to providing opportunities for students to excel not only academically but also athletically.`}
                limit={220}
              />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div className="flex flex-col rounded-[2px] overflow-hidden border border-gray-100 bg-gradient-to-b from-gray-50 via-blue-50/20 to-gray-50 transition-all duration-500">
            ...
            <div className="p-7 flex flex-col flex-grow">
              <AchievementReadMore
                text={`K.R. Mangalam University takes immense pride in celebrating the outstanding achievements of its students at the DPG Inter-University Sports Meet. Competing with exceptional skill and unwavering spirit, our teams showcased true determination and sportsmanship. The volleyball team secured 1st position, the football team secured 1st position, and the cricket team secured 2nd position. These accolades are a testament to the hard work, discipline, and team spirit of our talented players, who have once again demonstrated their excellence on the field. <br /> We extend our heartfelt appreciation to all the players, coaches, and mentors whose continuous guidance and dedication made this success possible. Their collective efforts not only brought laurels to the university but also strengthened the spirit of teamwork and resilience.`}
                limit={180}
              />
            </div>
          </div>
          ...
          <div className="flex flex-col rounded-[2px] overflow-hidden border border-gray-100 bg-gradient-to-b from-gray-50 via-blue-50/20 to-gray-50 transition-all duration-500">
            ...
            <div className="p-7 flex flex-col flex-grow">
              <AchievementReadMore
                text="We are thrilled to share the outstanding performance of our students at the Inter-University Sports Meet hosted by Aravali College of Engineering and Management. With passion, grit, and determination, our players delivered remarkable results, securing 2nd position in carrom, 2nd and 3rd positions in table tennis, 3rd position in football, 3rd position in the men's 400m individual event, and 3rd position in the men's 400m relay."
                limit={150}
              />
            </div>
          </div>
