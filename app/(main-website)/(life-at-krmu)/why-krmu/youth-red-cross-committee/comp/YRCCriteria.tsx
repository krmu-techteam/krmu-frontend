        ...
        <div>
          <ul className="text-white">
            <li className="flex items-center gap-3 py-1">
              ...
              <span>
                Must be a student of a recognised school, college, or
                university.
              </span>
            </li>
            <li className="flex items-center gap-3 py-1">
              ...
              <span>The age limit is typically between 15 and 30 years.</span>
            </li>
            <li className="flex items-center gap-3 py-1">
              <div className="bg-black rounded-full flex items-center justify-center p-1 w-[27px] h-[27px] ">
                <Check color="#ffffff" strokeWidth={3} />
              ...
              <span>
                Willingness to uphold and work towards the Red Cross principles
