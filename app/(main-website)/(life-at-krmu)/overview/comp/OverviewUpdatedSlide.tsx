    ...
    <>
      ...
      >
        <CarouselContent>
          {data &&
            data.map((item, i) => (
              <CarouselItem key={i} className="md:basis-1/2 flex pb-5">
                <div className="pt-2.5 px-2.5 pb-5 bg-[#172a45] rounded-sm flex flex-col h-full w-full">
                  ...
                  <div className="text-white mt-5 flex flex-col flex-grow">
                    ...
                    {item?.slug && (
                      <Link
                        ...
                        className="text-white text-xs underline underline-offset-2 mt-auto"
