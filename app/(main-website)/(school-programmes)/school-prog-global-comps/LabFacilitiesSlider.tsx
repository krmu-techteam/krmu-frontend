  ...
  return (
    <div>
      <Carousel
        ...
        setApi={setApi}
      >
        <CarouselContent className="-ml-4 sm:-ml-4 lg:-ml-6 px-0 my-5 flex items-stretch">
          {labcards &&
            labcards.map((item, i) => {
               const labImage = images[i % images.length];
               return (
              <CarouselItem key={i} className="pl-4 sm:pl-4 lg:pl-6 basis-full sm:basis-1/2 md:basis-1/3 flex">
                <div
