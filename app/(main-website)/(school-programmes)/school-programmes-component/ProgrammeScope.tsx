...
const ProgrammeScope = async ({
  ...
  return (
    <section className="bg-[#051730] py-8 xl:py-12 2xl:py-16">
      <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center gap-5 xl:gap-12 2xl:gap-16 px-4 sm:px-6 xl:px-10 2xl:px-0">
        {/* Left column: Image */}
        ...
        <div className="w-full md:w-1/2 md:text-left text-justify text-white">
          <h3 className="text-3xl text-center md:text-left sm:text-3xl xl:text-[40px] 2xl:text-[50px] font-bold leading-tight mb-3 xl:mb-3 2xl:mb-5">
            {scopeData?.scopeheading}
          </h3>
          <p className="text-base text-center md:text-left xl:text-[17px] 2xl:text-xl leading-relaxed md:leading-[1.7] opacity-90 mb-4 xl:mb-5 2xl:mb-8 max-w-3xl mx-auto md:mx-0">
