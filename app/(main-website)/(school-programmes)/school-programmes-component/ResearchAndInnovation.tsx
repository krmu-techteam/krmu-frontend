      ...
      <div className="relative z-10 max-w-[1319px] h-full mx-auto flex flex-col justify-between items-center">
        <div>
          ...
          >
            ...
            Through specialised laboratories, faculty-led projects, and
            innovation initiatives, students gain opportunities to participate
            in advanced technology research and interdisciplinary
            problem-solving.
          </p>
        </div>
