...
export default async function ExplorePrograms({ 
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 xl:px-10 2xl:px-0 relative z-10">
        ...
        />
          ...
          <div className="w-full lg:w-[60%] xl:w-[65%] flex flex-col justify-center py-12 md:py-16 lg:py-20">
            ...
            <div className="text-left lg:mb-4 2xl:mb-6">
              <h2 className="text-3xl md:text-[40px] font-semibold text-white mb-2 tracking-tight [text-shadow:0px_4px_4px_rgba(0,0,0,0.25)]">
                Explore Other Programmes
              </h2>
              <p className="text-[#d1cce5] [text-shadow:0px_4px_4px_rgba(0,0,0,0.25)] max-w-3xl text-base lg:text-[17px] 2xl:text-[18px] leading-relaxed">
