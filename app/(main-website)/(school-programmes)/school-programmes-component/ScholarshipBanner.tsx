      ...
      <div className="max-w-[1440px] mx-auto w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="shrink-0 w-full md:w-auto text-left md:text-right">
          <Link
            ...
            target="_blank"
            className="inline-block md:px-10 md:py-2.5 lg:px-12 lg:py-3.5 bg-white text-[#051630] font-bold text-sm md:text-md rounded-sm hover:bg-gray-100 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 shadow-md text-center w-full md:w-auto uppercase"
          >
            Explore
          </Link>
        </div>
