...
const ScholarshipBanner = () => {
  return (
    <section className="w-full bg-gradient-to-r from-[#051630] to-[#0161b0] py-8 xl:py-12 2xl:py-16 px-4 xl:px-10 2xl:px-0">
      <div className="max-w-[1440px] mx-auto w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="flex-1">
          ...
          <p className="text-sm md:text-base text-gray-200/90 max-w-3xl font-normal leading-relaxed">
        ...
        <div className="shrink-0 w-full md:w-auto text-left md:text-right">
          <Link
            ...
            target="_blank"
            className="inline-block px-10 py-3.5 bg-white text-[#051630] font-bold text-sm md:text-base rounded-sm hover:bg-gray-100 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 shadow-md text-center w-full md:w-auto"
          >
            Explore
          </Link>
        </div>
