...
const BeyondClassroom = ({
  ...
  return (
    <section className="prog-global-padding py-8 lg:py-10 xl:py-12 2xl:py-16 bg-[#051730]">
      <div className="max-w-full mx-auto w-full px-4 md:px-8 lg:px-10 xl:px-16">
