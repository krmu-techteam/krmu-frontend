      ...
      <section className="prog-global-padding bg-white py-8 md:py-16 shadow">
        <div className="max-w-[1440px] mx-auto w-full px-4 md:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl text-center md:text-center md:text-[42px] font-bold text-[#051630] leading-[1.1] mb-3 md:mb-4">
          ...
          <div className="relative group/slider px-0 xl:px-10 2xl:px-14">
            ...
            <div className="overflow-hidden cursor-grab active:cursor-grabbing pt-2 md:pt-0 pb-10 -my-10" ref={emblaRef}>
