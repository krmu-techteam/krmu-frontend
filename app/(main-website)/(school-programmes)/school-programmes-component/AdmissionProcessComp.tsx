    ...
    <section className="prog-global-padding bg-[#f9f9f9] py-8 md:py-16 px-4 md:px-0">
      ...
      <div className="flex items-center justify-center">
        ...
        <button
          ...
          } text-white  bg-[#db2a1a] hover:bg-[#c42518] w-full md:px-8 py-2.5 flex items-center justify-center gap-3 rounded-md font-semibold mt-8 cursor-pointer tracking-[0.025em] text-lg shadow-md hover:shadow-xl transition-all duration-300 group`}
        >
