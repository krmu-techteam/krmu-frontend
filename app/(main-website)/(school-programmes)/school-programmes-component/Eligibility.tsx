        ...
        <div className={`max-w-[1440px] w-full mx-auto`}>
          ...
          {(slug === "bba-hr" || slug === "btech-cse-ai-ml" || slug === "b-tech-cse") && heroSection?.imgvideo === "Video" ? (
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 rounded-3xl p-0 sm:p-4 lg:p-8 items-stretch">
              ...
              <div className="w-full bg-white rounded-sm md:rounded-3xl p-6 md:p-10 lg:w-1/2 flex flex-col justify-between shadow-xs">
                <div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 md:gap-4 mt-auto">
                  <button className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 md:px-8 py-3 border-[1.5px] border-gray-900 text-gray-900 font-medium rounded-sm md:rounded-[10px] hover:bg-gray-50 transition-all text-sm md:text-lg tracking-wide cursor-pointer whitespace-nowrap group">
                  ...
                  {formId ? (
                    <a
                      ...
                      className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 md:px-12 py-3 bg-[#cb000d] text-white font-medium rounded-sm md:rounded-[10px] shadow-lg hover:bg-[#b0000a] transition-all text-sm md:text-lg tracking-wide cursor-pointer whitespace-nowrap"
                    >
                      Apply Now
                    </a>
                  ) : (
