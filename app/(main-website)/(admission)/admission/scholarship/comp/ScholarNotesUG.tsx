          ...
          <div className="w-full lg:w-4/12 flex flex-col gap-5 justify-between">
              ...
              <div className="flex gap-5">
                ...
                <span className="text-white font-semibold text-base">
                  Above scholarship is applicable only on the first year
                  Programme fee
                </span>
              </div>
              <div className="flex gap-5">
              ...
              <div className="flex gap-5">
                ...
                <span className="text-white font-semibold text-base notesul">
                  ...
                  <ul className="font-normal">
                    ...
                    <li>
                      University will only cover Traveling allowance,
          ...
          <div className="w-full lg:w-3/12 flex flex-col gap-5">
            ...
            <div className="flex gap-5">
              ...
              <span className="text-white font-semibold text-base">
                ...
                papers (Except CUET -2 table given above ) and has an aggregate
                percentage of 40 or above will receive a 10% scholarship on
                their Programme Fee for Semester 1. If a student has attempted 4
                or more papers, the scholarship criteria outlined in the above
