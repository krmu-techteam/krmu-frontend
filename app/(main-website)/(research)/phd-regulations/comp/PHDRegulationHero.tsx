  ...
  return (
    <div className="flex flex-col xl:flex-row gap-20">
      <div className="w-full xl:w-3/5 text-white">
        <h1 className="text-3xl md:text-[43px] font-semibold mb-5">
          Ph.D. Programmes
        </h1>
        <p className="text-justify leading-[2]">
          ...
          research centres, the Ph.D. Cell aims to cultivate leaders equipped
          with ethical values and an understanding of environmental realities.
          This vision supports the university's aspiration to become an
          internationally recognised institution of higher learning, driving
