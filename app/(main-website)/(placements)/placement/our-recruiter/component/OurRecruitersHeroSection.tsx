const OurRecruitersHeroSection = () => {
  return (
    <>
      ...
      <section className="relative pt-24 sm:pt-32 md:pt-40 lg:pt-44 xl:pt-48 pb-12 md:pb-24 bg-[url(/placements/recruit-banner.webp)] bg-cover bg-no-repeat bg-[position:85%_top]  md:bg-right lg:bg-[95%_center] px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 overflow-hidden">
          ...
          <div className="w-full sm:w-[85%] md:w-[65%] lg:w-[55%] xl:w-[50%] space-y-4 md:space-y-6">
            ...
            <div className="space-y-3 md:space-y-4 text-sm sm:text-base md:text-lg leading-relaxed opacity-90">
              <p>
                ...
                experiential learning, skill development, and professional
                grooming has led to consistent and growing trust from top
                recruiters.
              </p>
              <p>
