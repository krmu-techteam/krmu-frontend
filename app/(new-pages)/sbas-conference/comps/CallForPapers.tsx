  ...
  return (
    <section className="bg-[#ede9dd] py-14 sm:py-16 md:py-20 xl:py-24 px-5 sm:px-6 md:px-10 xl:px-0">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col xl:flex-row gap-6 md:gap-8 mb-10 sm:mb-12">
          ...
          <div className="w-full xl:w-1/2">
            <div className="pt-6 px-5 sm:px-6 md:px-7 pb-7 bg-white rounded-[10px] border-t-3 border-[#c3a342] min-h-0 xl:min-h-[292px]">
              ...
              <ul className="text-sm leading-[21px] text-[#44504A] space-y-1">
                <li>
                  <strong>Title: </strong>
                  Times New Roman, 14 pt · Authors: 12 pt, underline presenter
                </li>

                <li>
                  <strong>Institution & Email: </strong>
                  Italic, Times New Roman, 11 pt
                </li>
          ...
          <div className="w-full xl:w-1/2">
            <div className="pt-6 px-5 sm:px-6 md:px-7 pb-7 bg-white rounded-[10px] border-t-3 border-[#2f5745] min-h-0 xl:min-h-[292px]">
              ...
              <ul className="text-sm leading-[21px] text-[#44504A] space-y-1">
                ...
                <li>
                  One participant per poster; board size 1.2m × 1.2m
                </li>

                <li>Apply for oral and/or poster presentation</li>

                <li>
                  State the focus area under which the abstract falls
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-[#19241f] rounded-[10px] py-5 sm:py-6 px-5 sm:px-6 md:px-7 space-y-2">
          <h5 className="text-[#C3A342] text-base font-bold font-lora">
            Publication Opportunities
          </h5>

          <p className="text-sm leading-5 sm:leading-[21px] text-[#BFC7BF]">
