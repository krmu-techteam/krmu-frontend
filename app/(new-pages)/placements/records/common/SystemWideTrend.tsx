  ...
  return (
    <section className="px-5 py-10 sm:py-12 md:py-16 lg:py-20">
      <div className="max-w-7xl mx-auto w-full ">
        <h3 className="text-xs sm:text-sm font-medium tracking-[4px] uppercase text-[#8d5552] mb-7">
          System-wide trend
        </h3>
        {/* Heading */}
        <div className="flex flex-col md:flex-row md:items-center gap-2 lg:gap-16">
          ...
          <div className="w-full md:w-1/2">
            <p className="text-sm sm:text-base leading-6 sm:leading-7 text-[#001836]/80 max-w-xl">
              Median compensation has shown a steady upward trajectory across
