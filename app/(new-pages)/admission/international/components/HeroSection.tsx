        ...
        <div className="w-full md:w-1/2 xl:w-9/12 flex items-start left-container">
          <div className="w-full xl:w-[55%] 2xl:w-3/5 col-1">
            ...
            <p className="font-inter text-xl">
              ...
              <strong>NAAC ‘A’ accredited</strong> <br className="hidden xl:block" /> universities and experience
              internationally recognised <br className="hidden xl:block" /> education in the heart of Gurugram,
              India's leading <br className="hidden xl:block" /> corporate and innovation hub.
            </p>
