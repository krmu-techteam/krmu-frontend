...
const RankingRecognition = () => {
  return (
    <section className="px-5 xl:px-0">
      <div className="bg-[linear-gradient(145.75deg,#FFFFFF_19.74%,#EDECE4_79.7%)] p-5 sm:py-10 sm:px-10 xl:px-20 max-w-[1664px] -mt-52 mx-auto rounded-[10px] z-30 relative shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
