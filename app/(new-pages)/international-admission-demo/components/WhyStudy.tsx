...
const WhyStudy = () => {
  return (
    <section className="bg-[linear-gradient(98.17deg,#001732_55.07%,#004698_99.64%)]">
      <div className="max-w-[1664px] mx-auto py-20 flex items-center">
        <div className="w-1/2 text-white">
          <h3 className="font-poppins text-6xl font-bold mb-5">Why Study in India?</h3>
      ...
      <div className="w-full pl-20 z-30 relative">
        <WhyStudySlide />
      </div>
    </section>
  );
