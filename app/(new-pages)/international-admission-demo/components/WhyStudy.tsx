...
const WhyStudy = () => {
  return (
    <section className="bg-[linear-gradient(98.17deg,#001732_55.07%,#004698_99.64%)] overflow-hidden px-5 pb-20 sm:pb-0">
      <div className="max-w-[1664px] mx-auto py-10 md:py-20 flex flex-col md:flex-row items-center">
