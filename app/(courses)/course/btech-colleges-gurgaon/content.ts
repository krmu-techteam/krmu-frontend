...
export const faqData = [
  ...
  {
    ques: "How should I filter the best B.Tech. colleges in Gurgaon?",
    ans: "While choosing top colleges in Gurgaon for B.Tech., you must ensure that the college is accredited and recognised by regulatory bodies, has an experienced faculty, offers great placement and industrial exposure, and, most importantly, has recruitment partnerships with leading tech firms.",
  },
  {
