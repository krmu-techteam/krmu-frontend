      ...
      <div className="max-w-[1296px] mx-auto w-full">
        <div className="mb-12 text-center">
          <h3 className="text-2xl md:text-4xl font-semibold mb-5">
            Why Study{" "}
            <span className="text-[#e31e24]"> Engineering in Delhi NCR?</span>
          </h3>
          <p className="mb-4">
            Studying at one of the top engg colleges in Delhi NCR places you at
            the epicentre of India's fastest-growing Tech and Corporate
            Ecosystem. You get direct access to internships and high-paying
            careers in the tech hubs of Gurugram and Noida.
          </p>
        </div>
