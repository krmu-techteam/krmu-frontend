...
import HeroCourseMarquee from "./HeroCourseMarquee";
import { heroCourseMarqueeData } from "../btech-cse-course/content";
...
export default function Header() {
  ...
  const marqueeData = heroCourseMarqueeData;
  ...
  return (
    <>
      ...
      >
        ...
        <nav className="px-3 flex items-center justify-between py-2.5">
          {/* Logo */}
          <Link href="/">
            <Image
