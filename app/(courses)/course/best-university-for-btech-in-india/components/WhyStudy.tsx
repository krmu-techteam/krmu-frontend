        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="ncr-benefit-card h-full">
            ...
            <p className="benefit-text">
              Gurgaon, a major Delhi NCR technology and corporate hub housing
              the best universities in India for B.Tech. CSE offers B.Tech.
              students strong industry exposure, modern infrastructure,
