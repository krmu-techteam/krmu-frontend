    ...
    <section className="py-[50px] px-4 googleSansFamily">
      <div className="max-w-[1296px] mx-auto w-full">
        <div className="mb-12 text-center">
          ...
          <p className="mb-4">
            Learn & Launch your Engineering Career at India's fastest-growing
            Tech and Corporate Ecosystem.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="ncr-benefit-card h-full">
            ...
            <p className="benefit-text">
              Gurgaon, a major Delhi NCR technology and corporate hub, with the
              best colleges for B.Tech. CSE offers B.Tech. students strong
              industry exposure, modern infrastructure, excellent connectivity,
              and access to startups, global companies, and diverse career
              opportunities.
            </p>
          </div>
