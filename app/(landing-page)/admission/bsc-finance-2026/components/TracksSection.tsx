      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-6 flex flex-col items-center gap-10 sm:gap-12">
        ...
        <div className="flex flex-wrap gap-3 items-center justify-center">
          <CommonLeadPopup
            ...
            buttonClassName="inline-flex items-center gap-2 px-5 py-[10px] rounded-lg border border-[#D1D1D1] bg-white text-[#344054] hover:bg-gray-50 font-semibold text-[14px] leading-5 tracking-normal transition-all duration-200"
