    ...
    <>
      ...
      >
        ...
        <div className="relative z-[2] max-w-[1300px] mx-auto w-full px-4 sm:px-6 pt-24 sm:pt-32 lg:pt-28 pb-10 sm:pb-16 flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-12">
          ...
          {/* RIGHT — Form content */}
          <div id="apply-form" className="w-full lg:w-[42%] lg:max-w-[450px] shrink-0 self-center lg:self-start lg:mt-0 mt-8"> 
          
                <div className="min-h-[580px]">
                   <NoPaperFormsWidget widgetId="047a23de933bd996c4c01578fad16790" height="580px" />
                </div>
