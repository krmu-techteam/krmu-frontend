...
const faqData = [
  ...
  {
    question:
      "Is this programme more theoretical or practical?",
    answer:
  ...
  {
    question:
      "Can I work or freelance while pursuing this MA?",
    answer:
  ...
  {
    question:
      "Does this programme help if I want to do a Ph.D later?",
    answer:
  ...
  {
    question: "Is the School of Emerging Media and Creator Economy the same as the former School of Journalism and Mass Communication?",
    answer: "The School of Journalism and Mass Communication has been renamed as the School of Emerging Media and Creator Economy (SEMCE). The new name reflects an expanded focus on digital media, content creation, and evolving industry trends, while continuing the legacy and academic foundation of the former school.",
  },
];
const FAQSection = () => {
          ...
          {faqData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <h3 className="text-[16px] md:text-[18px] font-normal text-[#000000]">
                    {item.question}
                  </h3>
                  <ChevronDown
                    size={28}
                ...
                >
                  <div className="overflow-hidden">
                    <div className="px-6 md:px-8 pb-6">
                      <p className="text-gray-700 text-sm md:text-base leading-relaxed max-w-5xl">
                        {item.answer}
                      </p>
                    </div>
                  </div>
