...
const LeaveWith = () => {
  ...
  const renderIcon = (iconName: string) => {
    ...
    if (IconComponent) {
      return (
        <IconComponent className="w-[24px] h-[24px] text-[#EDBA55] group-hover:scale-105 transition-transform duration-300" />
      );
    }
    return <Icons.HelpCircle className="w-[24px] h-[24px] text-[#EDBA55]" />;
  };
