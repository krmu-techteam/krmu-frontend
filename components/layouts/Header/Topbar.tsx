...
const Topbar = ({ topbarmenu, sociallinks }: TopbarProps) => {
  return (
    <div className="flex bg-[#061623] text-white/80 py-2 px-4 md:px-16 text-xs justify-center xl:justify-between items-center border-b border-white/10 w-full relative z-60 transition-colors">
